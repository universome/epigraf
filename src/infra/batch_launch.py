...
def batch_launch(launcher: str, experiments_root_dir: os.PathLike, cfg: DictConfig, datasets: List[str], print_only: bool, time: str, use_qos: bool=False, other_args: Dict={}, num_gpus: int=4, *args, **kwargs):
    for dataset in datasets:
        for exp_args in construct_experiments_args(cfg, *args, **kwargs):
            exp_args['sbatch_args.time'] = time
            exp_args['experiments_root_dir'] = experiments_root_dir
            ...
            if print_only:
                os.makedirs(exp_args['experiments_root_dir'], exist_ok=True)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--project_dir', type=str, default='/ibex/ai/home/skoroki/rnf', help='Project directory path')
    ...
    experiments_root_dir = f'experiments/{user}/{args.series_name}'
